...
- Il tentativo di presa si esegue a terra con `pugno leggero + calcio leggero`: se raggiunge l'avversario mantiene l'ultimo frame e immobilizza entrambi; se manca, torna dai frame 24–1 e poi in `IDLE`.
