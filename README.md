...
Le cinque suite verificano 518 condizioni relative ad animazioni, `AttackData`, `AttackVariantData`, input buffer, combattimento, UI, KO e reset. Ogni processo pubblica il proprio risultato e il runner aggregato termina con `SMOKE_TESTS_OK`.

> Baseline del 1 settembre 2026: 518 asserzioni superate in cinque suite, nessun fallimento e risultato aggregato `SMOKE_TESTS_OK` con Godot 4.7.
