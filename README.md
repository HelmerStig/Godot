...
- Le reazioni `hurt_high` e `hurt_low` di Arianna usano temporaneamente le rispettive pose Arianna da 512 px, evitando che le animazioni ereditate mostrino Mangler quando Player 1 viene colpita.
- Ogni reazione `hurt_medium` o `hurt_low`, per qualsiasi fighter, genera un'esplosione azzurra con 64 scintille all'altezza dello stomaco.
