# Esempi didattici storici

Gli esempi seguenti precedono i cataloghi runtime e non vanno copiati direttamente nei controller attuali. Vedere [guida corrente](../../TUTORIAL_ANIMAZIONI.md).
