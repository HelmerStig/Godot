# Archivio precedente al riordino dell’8 settembre 2026

Questa copia conserva specifiche e note storiche; può descrivere comportamenti superati. Per lo stato corrente consultare [README](../../README.md), [frame data](../../FRAME_DATA.md) e [test](../../tests/README.md).
...
Le cinque suite verificano 534 condizioni relative ad animazioni, `AttackData`, `AttackVariantData`, input buffer, combattimento, UI, KO e reset. Ogni processo pubblica il proprio risultato e il runner aggregato termina con `SMOKE_TESTS_OK`.

> Baseline del 3 settembre 2026: 534 asserzioni superate in cinque suite, nessun fallimento e risultato aggregato `SMOKE_TESTS_OK` con Godot 4.7.
